...
export function UploadWidgetUploadItem(){
     return(
          <motion.div 
               className="p3 roumded-lg flex flex-col gap-3 shadow-shape-content bg-white/2 relative overflow-hidder [&+div]:nt-2"
               initial={{opacity: 0}}
               animate={{opacity:1}}
          ...
          >
               ...
               <div className="absolute top-2.5 right-2.5 flex items-center gap-1">
                    <Button size="icon-sm">
                         ...
                         <span className="sr-only">Dowloand compressed image</span>
                    </Button>
